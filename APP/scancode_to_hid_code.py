...
if sys.platform == "win32":  # Windows
    ...
    class ScanCodeList(enum.Enum):
        ...
        Return = ScanCode(KeyType.KEYBOARD, 0x28, 0x1C,
                          pynput.keyboard.Key.enter, 'Return')
        Escape = ScanCode(KeyType.KEYBOARD, 0x29, 0x01,
                          pynput.keyboard.Key.esc, 'Escape')
        Backspace = ScanCode(KeyType.KEYBOARD, 0x2A, 0x0E,
                             pynput.keyboard.Key.backspace, 'Backspace')
        Tab = ScanCode(KeyType.KEYBOARD, 0x2B, 0x0F,
                       pynput.keyboard.Key.tab, 'Tab')
        Space = ScanCode(KeyType.KEYBOARD, 0x2C, 0x39,
        ...
        KEY_0x39 = ScanCode(KeyType.KEYBOARD, 0x39, 0x3A,
                            pynput.keyboard.Key.caps_lock, 'Caps Lock')
        KEY_0x3A = ScanCode(KeyType.KEYBOARD, 0x3A, 0x3B,
                            pynput.keyboard.Key.f1, 'F1')
        KEY_0x3B = ScanCode(KeyType.KEYBOARD, 0x3B, 0x3C,
                            pynput.keyboard.Key.f2, 'F2')
        KEY_0x3C = ScanCode(KeyType.KEYBOARD, 0x3C, 0x3D,
                            pynput.keyboard.Key.f3, 'F3')
        KEY_0x3D = ScanCode(KeyType.KEYBOARD, 0x3D, 0x3E,
                            pynput.keyboard.Key.f4, 'F4')
        KEY_0x3E = ScanCode(KeyType.KEYBOARD, 0x3E, 0x3F,
                            pynput.keyboard.Key.f5, 'F5')
        KEY_0x3F = ScanCode(KeyType.KEYBOARD, 0x3F, 0x40,
                            pynput.keyboard.Key.f6, 'F6')
        KEY_0x40 = ScanCode(KeyType.KEYBOARD, 0x40, 0x41,
                            pynput.keyboard.Key.f7, 'F7')
        KEY_0x41 = ScanCode(KeyType.KEYBOARD, 0x41, 0x42,
                            pynput.keyboard.Key.f8, 'F8')
        KEY_0x42 = ScanCode(KeyType.KEYBOARD, 0x42, 0x43,
                            pynput.keyboard.Key.f9, 'F9')
        KEY_0x43 = ScanCode(KeyType.KEYBOARD, 0x43, 0x44,
                            pynput.keyboard.Key.f10, 'F10')
        KEY_0x44 = ScanCode(KeyType.KEYBOARD, 0x44, 0x57,
                            pynput.keyboard.Key.f11, 'F11')
        KEY_0x45 = ScanCode(KeyType.KEYBOARD, 0x45, 0x58,
                            pynput.keyboard.Key.f12, 'F12')
        KEY_0x46 = ScanCode(KeyType.KEYBOARD, 0x46, 0xE037,
                            pynput.keyboard.Key.print_screen, 'Print Screen')
        KEY_0x47 = ScanCode(KeyType.KEYBOARD, 0x47, 0x46,
                            pynput.keyboard.Key.scroll_lock, 'Scroll Lock')
        KEY_0x48 = ScanCode(KeyType.KEYBOARD, 0x48, 0xE046E0C6,
                            pynput.keyboard.Key.pause, 'Pause')
        KEY_0x49 = ScanCode(KeyType.KEYBOARD, 0x49, 0xE052,
                            pynput.keyboard.Key.insert, 'Insert')
        KEY_0x4A = ScanCode(KeyType.KEYBOARD, 0x4A, 0xE047,
                            pynput.keyboard.Key.home, 'Home')
        KEY_0x4B = ScanCode(KeyType.KEYBOARD, 0x4B, 0xE049,
                            pynput.keyboard.Key.page_up, 'Page Up')
        KEY_0x4C = ScanCode(KeyType.KEYBOARD, 0x4C, 0xE053,
                            pynput.keyboard.Key.delete, 'Delete')
        KEY_0x4D = ScanCode(KeyType.KEYBOARD, 0x4D, 0xE04F,
                            pynput.keyboard.Key.end, 'End')
        KEY_0x4E = ScanCode(KeyType.KEYBOARD, 0x4E, 0xE051,
                            pynput.keyboard.Key.page_down, 'Page Down')
        KEY_0x4F = ScanCode(KeyType.KEYBOARD, 0x4F, 0xE04D,
                            pynput.keyboard.Key.right, 'Right Arrow')
        KEY_0x50 = ScanCode(KeyType.KEYBOARD, 0x50, 0xE04B,
                            pynput.keyboard.Key.left, 'Left Arrow')
        KEY_0x51 = ScanCode(KeyType.KEYBOARD, 0x51, 0xE050,
                            pynput.keyboard.Key.down, 'Down Arrow')
        KEY_0x52 = ScanCode(KeyType.KEYBOARD, 0x52, 0xE048,
                            pynput.keyboard.Key.up, 'Up Arrow')
        KEY_0x53 = ScanCode(KeyType.KEYBOARD, 0x53, 0x45,
        ...
        KEY_0x58 = ScanCode(KeyType.KEYBOARD, 0x58,
                            0xE01C, None, 'Keypad Enter')
        ...
        KEY_0x68 = ScanCode(KeyType.KEYBOARD, 0x68, 0x5D,
                            pynput.keyboard.Key.f13, 'F13')
        KEY_0x69 = ScanCode(KeyType.KEYBOARD, 0x69, 0x5E,
                            pynput.keyboard.Key.f14, 'F14')
        KEY_0x6A = ScanCode(KeyType.KEYBOARD, 0x6A, 0x5F,
                            pynput.keyboard.Key.f15, 'F15')
        KEY_0x6B = ScanCode(KeyType.KEYBOARD, 0x6B, None,
                            pynput.keyboard.Key.f16, 'F16')
        KEY_0x6C = ScanCode(KeyType.KEYBOARD, 0x6C, None,
                            pynput.keyboard.Key.f17, 'F17')
        KEY_0x6D = ScanCode(KeyType.KEYBOARD, 0x6D, None,
                            pynput.keyboard.Key.f18, 'F18')
        KEY_0x6E = ScanCode(KeyType.KEYBOARD, 0x6E, None,
                            pynput.keyboard.Key.f19, 'F19')
        KEY_0x6F = ScanCode(KeyType.KEYBOARD, 0x6F, None,
                            pynput.keyboard.Key.f20, 'F20')
        KEY_0x70 = ScanCode(KeyType.KEYBOARD, 0x70, None,
                            pynput.keyboard.Key.f21, 'F21')
        KEY_0x71 = ScanCode(KeyType.KEYBOARD, 0x71, None,
                            pynput.keyboard.Key.f22, 'F22')
        KEY_0x72 = ScanCode(KeyType.KEYBOARD, 0x72, None,
                            pynput.keyboard.Key.f23, 'F23')
        KEY_0x73 = ScanCode(KeyType.KEYBOARD, 0x73, None,
                            pynput.keyboard.Key.f24, 'F24')
        ...
        LEFT_CTRL = ScanCode(KeyType.KEYBOARD, 0xE0, 0x1D,
                             pynput.keyboard.Key.ctrl_l, 'Left Control')
        LEFT_SHIFT = ScanCode(KeyType.KEYBOARD, 0xE1, 0x2A,
                              pynput.keyboard.Key.shift_l, 'Left Shift')
        LEFT_ALT = ScanCode(KeyType.KEYBOARD, 0xE2, 0x38,
                            pynput.keyboard.Key.alt_l, 'Left Alt')
        LEFT_GUI = ScanCode(KeyType.KEYBOARD, 0xE3, 0xE05B,
                            pynput.keyboard.Key.cmd_l, 'Left GUI')
        RIGHT_CTRL = ScanCode(KeyType.KEYBOARD, 0xE4, 0xE01D,
                              pynput.keyboard.Key.ctrl_r, 'Right Control')
        RIGHT_SHIFT = ScanCode(KeyType.KEYBOARD, 0xE5,
                               0x36, pynput.keyboard.Key.shift_r, 'Right Shift')
        RIGHT_ALT = ScanCode(KeyType.KEYBOARD, 0xE6, 0xE038,
                             pynput.keyboard.Key.alt_r, 'Right Alt')
        RIGHT_GUI = ScanCode(KeyType.KEYBOARD, 0xE7, 0xE05C,
                             pynput.keyboard.Key.cmd_r, 'Right GUI')
        # ScanCode('07', 'E8-FFFF', (', 'RESERVED',', 'RESERVED'), 'RESERVED')
        MEDIA_NEXT = ScanCode(KeyType.CONSUMER, 0x00B5, 0xE019,
                              pynput.keyboard.Key.media_next, 'Next Track')
        MEDIA_PREVIOUS = ScanCode(KeyType.CONSUMER, 0x00B6, 0xE010,
                                  pynput.keyboard.Key.media_previous, 'Previous Track')
        MEDIA_STOP = ScanCode(KeyType.CONSUMER, 0x00B7, 0xE024, None, 'Stop')
        MEDIA_PLAY_PAUSE = ScanCode(
            KeyType.CONSUMER, 0x00CD, 0xE022, pynput.keyboard.Key.media_play_pause, 'Play/Pause')
        MEDIA_MUTE = ScanCode(KeyType.CONSUMER, 0x00E2, 0xE020,
                              pynput.keyboard.Key.media_volume_mute, 'Mute')
        # ScanCode(0x0C, 0x00E5, None, None, 'Bass Boost'
        # ScanCode(0x0C, 0x00E7, (None, None, 'Loudness')
        MEDIA_VOL_UP = ScanCode(KeyType.CONSUMER, 0x00E9, 0xE030,
                                pynput.keyboard.Key.media_volume_up, 'Volume Up')
        MEDIA_VOL_DOWN = ScanCode(KeyType.CONSUMER, 0x00EA, 0xE02E,
                                  pynput.keyboard.Key.media_volume_down, 'Volume Down')
        ...
        MEDIA_SELECT = ScanCode(KeyType.CONSUMER, 0x0183,
                                0xE06D, None, 'Media Select')
        MAIL = ScanCode(KeyType.CONSUMER, 0x018A, 0xE06C, 180, 'Mail')
        CALCULATOR = ScanCode(KeyType.CONSUMER, 0x0192,
                              0xE021, 183, 'Calculator')
        MY_COMPUTER = ScanCode(KeyType.CONSUMER, 0x0194,
                               0xE06B, 182, 'My Computer')
        WWW_SEARCH = ScanCode(KeyType.CONSUMER, 0x0221,
                              0xE065, 170, 'WWW Search')
        ...
        WWW_FORWARD = ScanCode(KeyType.CONSUMER, 0x0225,
                               0xE069, 167, 'WWW Forward')
        WWW_STOP = ScanCode(KeyType.CONSUMER, 0x0226, 0xE068, 169, 'WWW Stop')
        WWW_REFRESH = ScanCode(KeyType.CONSUMER, 0x0227,
                               0xE067, 168, 'WWW Refresh')
        WWW_FAVORITES = ScanCode(
            KeyType.CONSUMER, 0x022A, 0xE066, 171, 'WWW Favorites')
...
elif sys.platform == "linux":  # Linux (duh)
